 ...
 */
internal class RssItems3Adapter(val context: Context) : RecyclerView.Adapter<RssItems3Adapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RssItems3Adapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_rss_item, parent, false)
        return ViewHolder(view)
    }


    override fun onBindViewHolder(holder: RssItems3Adapter.ViewHolder, position: Int) {
        holder.apply {
            ...
            itemView.setOnClickListener {
                ...
                intent.putExtra("isComingFrom","fourth")
